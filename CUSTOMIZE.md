...
- remove reference to blog page in our dropdown.md
...
- remove reference to projects page in ourdropdown.md
...
- remove reference to publications page in our dropdown.md
